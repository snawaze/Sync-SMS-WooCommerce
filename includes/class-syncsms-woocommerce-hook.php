...
class Syncsmssms_WooCommerce_Hook implements Syncsmssms_Register_Interface
{
    protected $notification_ins;

    public function __construct(Syncsmssms_WooCommerce_Notification $notification_ins)
    {
    ...
    {
        syncsms_add_actions($this->get_core_actions());
    }
